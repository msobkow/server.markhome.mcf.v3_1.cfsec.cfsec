// Description: Java 25 interface for a Service history primary key object
...
/**
 *	ICFSecServiceHPKey History Primary Key interface for Service
 *		requiredServiceId	Required object attribute ServiceId. */
public interface ICFSecServiceHPKey
{
