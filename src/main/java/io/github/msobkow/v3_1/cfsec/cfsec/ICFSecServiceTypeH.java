// Description: Java 25 interface for a ServiceType history object
...
/**
 *	ICFSecServiceTypeH provides access to history records matching the CFSecServiceType object change history.
 */
public interface ICFSecServiceTypeH
{
