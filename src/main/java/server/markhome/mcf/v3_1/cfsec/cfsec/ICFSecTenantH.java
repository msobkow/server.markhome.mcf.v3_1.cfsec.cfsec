// Description: Java 25 interface for a Tenant history object
...
/**
 *	ICFSecTenantH provides access to history records matching the CFSecTenant object change history.
 */
public interface ICFSecTenantH
{
