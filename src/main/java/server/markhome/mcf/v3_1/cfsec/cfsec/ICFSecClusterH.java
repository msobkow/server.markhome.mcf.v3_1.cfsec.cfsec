// Description: Java 25 interface for a Cluster history object
...
/**
 *	ICFSecClusterH provides access to history records matching the CFSecCluster object change history.
 */
public interface ICFSecClusterH
{
