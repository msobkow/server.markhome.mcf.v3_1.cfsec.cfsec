...
// Description: Java JPA Factory interface for SecGrpMemb.
...
/*
 *	ICFSecSecGrpMembFactory interface for SecGrpMemb
 */
public interface ICFSecSecGrpMembFactory
{
	 ...
	 */
	ICFSecSecGrpMembHPKey newHPKey();
	...
	/**
	 *	Allocate a SecGrpMemb interface implementation.
	 *
	 *	@return	The new instance.
	 */
	...
	/**
	 *	Allocate a SecGrpMemb history interface implementation.
	 *
	 *	@return	The new instance.
	 */
