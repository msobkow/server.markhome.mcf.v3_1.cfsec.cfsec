// Description: Java 25 interface for a HostNode history primary key object
...
/**
 *	ICFSecHostNodeHPKey History Primary Key interface for HostNode
 *		requiredHostNodeId	Required object attribute HostNodeId. */
public interface ICFSecHostNodeHPKey
{
