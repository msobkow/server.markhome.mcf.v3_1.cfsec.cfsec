// Description: Java 25 interface for a ISOLang history object
...
/**
 *	ICFSecISOLangH provides access to history records matching the CFSecISOLang object change history.
 */
public interface ICFSecISOLangH
{
