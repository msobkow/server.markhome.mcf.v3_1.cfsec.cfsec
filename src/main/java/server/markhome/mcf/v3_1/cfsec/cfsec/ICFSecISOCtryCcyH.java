// Description: Java 25 interface for a ISOCtryCcy history object
...
/**
 *	ICFSecISOCtryCcyH provides access to history records matching the CFSecISOCtryCcy object change history.
 */
public interface ICFSecISOCtryCcyH
{
