// Description: Java 25 interface for a TSecGrpMemb history object
...
/**
 *	ICFSecTSecGrpMembH provides access to history records matching the CFSecTSecGrpMemb object change history.
 */
public interface ICFSecTSecGrpMembH
{
