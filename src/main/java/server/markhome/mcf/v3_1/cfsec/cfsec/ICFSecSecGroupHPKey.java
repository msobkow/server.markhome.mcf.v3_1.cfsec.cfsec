// Description: Java 25 interface for a SecGroup history primary key object
...
/**
 *	ICFSecSecGroupHPKey History Primary Key interface for SecGroup
 *		requiredSecGroupId	Required object attribute SecGroupId. */
public interface ICFSecSecGroupHPKey
{
