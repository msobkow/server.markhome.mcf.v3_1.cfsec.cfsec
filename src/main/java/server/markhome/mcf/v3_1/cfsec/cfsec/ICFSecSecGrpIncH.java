// Description: Java 25 interface for a SecGrpInc history object
...
/**
 *	ICFSecSecGrpIncH provides access to history records matching the CFSecSecGrpInc object change history.
 */
public interface ICFSecSecGrpIncH
{
