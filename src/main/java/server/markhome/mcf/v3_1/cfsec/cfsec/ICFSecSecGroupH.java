// Description: Java 25 interface for a SecGroup history object
...
/**
 *	ICFSecSecGroupH provides access to history records matching the CFSecSecGroup object change history.
 */
public interface ICFSecSecGroupH
{
