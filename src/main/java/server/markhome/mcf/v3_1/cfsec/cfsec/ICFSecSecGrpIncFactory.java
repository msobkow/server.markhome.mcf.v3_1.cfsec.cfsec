...
// Description: Java JPA Factory interface for SecGrpInc.
...
/*
 *	ICFSecSecGrpIncFactory interface for SecGrpInc
 */
public interface ICFSecSecGrpIncFactory
{
	...
	/**
	 *	Allocate a SecGrpInc interface implementation.
	 *
	 *	@return	The new instance.
	 */
	...
	/**
	 *	Allocate a SecGrpInc history interface implementation.
	 *
	 *	@return	The new instance.
	 */
