// Description: Java 25 interface for a TSecGroup history object
...
/**
 *	ICFSecTSecGroupH provides access to history records matching the CFSecTSecGroup object change history.
 */
public interface ICFSecTSecGroupH
{
