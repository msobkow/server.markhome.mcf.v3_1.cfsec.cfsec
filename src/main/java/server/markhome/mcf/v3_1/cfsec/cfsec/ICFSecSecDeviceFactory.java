...
// Description: Java JPA Factory interface for SecDevice.
...
/*
 *	ICFSecSecDeviceFactory interface for SecDevice
 */
public interface ICFSecSecDeviceFactory
{
	...
	/**
	 *	Allocate a SecDevice interface implementation.
	 *
	 *	@return	The new instance.
	 */
	...
	/**
	 *	Allocate a SecDevice history interface implementation.
	 *
	 *	@return	The new instance.
	 */
