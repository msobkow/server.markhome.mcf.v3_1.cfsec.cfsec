// Description: Java 25 interface for a ISOCcy history object
...
/**
 *	ICFSecISOCcyH provides access to history records matching the CFSecISOCcy object change history.
 */
public interface ICFSecISOCcyH
{
