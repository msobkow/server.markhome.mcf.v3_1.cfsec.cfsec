// Description: Java 25 interface for a ISOCtry history object
...
/**
 *	ICFSecISOCtryH provides access to history records matching the CFSecISOCtry object change history.
 */
public interface ICFSecISOCtryH
{
