// Description: Java 25 interface for a SecDevice history object
...
/**
 *	ICFSecSecDeviceH provides access to history records matching the CFSecSecDevice object change history.
 */
public interface ICFSecSecDeviceH
{
