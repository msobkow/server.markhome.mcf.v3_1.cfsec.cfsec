// Description: Java 25 interface for a Service history object
...
/**
 *	ICFSecServiceH provides access to history records matching the CFSecService object change history.
 */
public interface ICFSecServiceH
{
